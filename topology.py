...
def topology():
	...
	ap1 = net.addAccessPoint('ap1',ssid="Estudiantes,Docentes,Administrativo", mode='g', channel='11', mac='e0:10:7f:af:b7:a8', range=20, position="15,30,0")
	# Access Point Segundo piso de biblioteca
	ap2 = net.addAccessPoint('ap2',ssid="Estudiantes,Docentes,Administrativo", mode='g', channel='6', mac='f0:b0:52:7a:31:19', range=20,position="30,40,0")
	# Access Point restante (no encontrado)
	ap3 = net.addAccessPoint('ap3',ssid="Estudiantes,Docentes,Administrativo", mode='g', channel='1', mac='2c:5d:93:bd:83:5c',range=20,position="50,50,0")
