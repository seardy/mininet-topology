...
def topology():
	...
	ap1 = net.addAccessPoint('Sistemas',ssid="Estudiantes,Docentes", mode='g', channel='11', mac='e0:10:7f:af:b7:a8', range=20, position="15,30,0")
	# Access Point Segundo piso de biblioteca
	ap2 = net.addAccessPoint('Segundo piso',ssid="Estudiantes,Docentes", mode='g', channel='6', mac='f0:b0:52:7a:31:19', range=20,position="30,40,0")
